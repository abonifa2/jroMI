...
#print etg_time - stg_time, "seconds process time for the module 'geom' "
#print time.clock() -stg_time, "seconds process time for the module 'geom' "  
...
#print etc_time - stc_time, "seconds process time for the module 'covs' "

#print time.clock() -stc_time, "seconds process time for the module 'covs' "  
...
if __name__=='__main__':   
    ...
    # Profiling the modules
    
    cProfile.run('geom(tx,ty,dr)')
    cProfile.run('covs(px,py,uB,Bo,theta,uphi,uthe,Ne,h)')
